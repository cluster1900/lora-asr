...
| 02 | [Baseline 评估](./02_baseline_eval.md) | 测出 Gemma 4 原始 ASR 能力 | 01 | baseline JSONL 和 WER/CER 指标产出 |
...
| 05 | [LoRA 训练 MVP](./05_lora_training_mvp.md) | 跑通第一版 Gemma 4 QLoRA | 02, 03, 04 | adapter 可保存、加载、评测 |
